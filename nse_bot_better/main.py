...
# ==========================================
# Update these values with your latest Pine Script winner.
# The script will test this first and set it as the baseline to beat.
LAST_WINNER = {
...
def run_robust_optimization():
    ...
    # --- NEW: EVALUATE LAST WINNER FIRST ---
    ...
    if score > -900: 
        ...
        print(f"Filter: {f_str} | Trail: {tr_str}")
