...
public final class TRMTConfig {
    ...
    /**
     * Untransformed erosion progress (e.g. a footpath someone walked on a little and never
     * returned to) is discarded after this many real-time days of inactivity, so the saved
     * erosion data doesn't grow forever. Does not affect already-placed eroded blocks, which
     * are governed by their own de-erosion timeouts above. Set to 0 to disable pruning.
     */
    public float staleEntryTimeoutDays = 30f;
